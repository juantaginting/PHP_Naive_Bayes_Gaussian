				...
				<div class="box-body">
					...
					<table class="table">
						...
						<tbody>
							...
							<tr>
								<td><?= $no++ ?></td>
								<td><img src="../uploads/galeri/<?= $p['foto'] ?>" width="250px"></td>
								<td><?= $p['keterangan'] ?></td>
								<td>
									<a href="edit-galeri.php ?id=<?= $p['id']?>"  title="Edit Data" class="text-orange"><i class="fa fa-edit"></i></a>
									<a href="hapus.php ?idgaleri=<?= $p['id']?>" onclick="return confirm('yakin ingin menghapus ?')"title="Hapus Data" class="text-red"><i class="fa fa-times"></i></a>
								</td>
							</tr>
